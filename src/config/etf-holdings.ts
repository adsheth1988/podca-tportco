...
export const ETF_HOLDINGS: Record<string, ETFInfo> = {
  SPY: {
    ...
    holdings: [
      ...
      { ticker: "GOOGL", name: "Alphabet Inc. A",       weight: 2.25 },
      { ticker: "GOOG",  name: "Alphabet Inc. C",       weight: 2.02 },
  ...
  QQQM: {
    ...
    holdings: [
      ...
      { ticker: "GOOGL", name: "Alphabet Inc. A",       weight: 4.12 },
      { ticker: "GOOG",  name: "Alphabet Inc. C",       weight: 3.89 },
